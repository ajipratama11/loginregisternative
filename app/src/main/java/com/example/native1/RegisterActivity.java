...
import com.example.native1.Interface.RegisterInterface;
...
public class RegisterActivity extends AppCompatActivity {
    private EditText etname, etusername, etemail,ettelp, etpassword;
    ...
    private void registerMe() {
        ...
        Call<String> call = api.getUserRegi(name,username,email,telp, password);
        ...
        try {
            ...
            if (jsonObject.getString("status").equals("true")) {
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    preferenceHelper.putTelp(dataobj.getString("telp"));
                }
            }
        } catch (JSONException e) {
            e.printStackTrace();
